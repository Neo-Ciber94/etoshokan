...
{#if !readingMode.active}
	...
	<nav
		class="fixed top-0 bottom-0 left-0 z-40 hidden min-w-16 max-w-20 flex-col items-center justify-center gap-4 border-r border-border bg-card max-lg:landscape:flex"
	>
