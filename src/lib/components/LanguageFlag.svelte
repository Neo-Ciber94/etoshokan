<script lang="ts">
	let { language, class: className = '' }: { language: string; class?: string } = $props();
</script>
...
{:else if language === 'es'}
	<svg
		...
		/><path fill="#f4a2b2" d="M12 16h3v3h-3z" /><path fill="#dd2e44" d="M9 16h3v3H9z" /><ellipse
			...
			rx="3"
			ry="1.5"
		/><ellipse cx="12" cy="13.75" fill="#ffac33" rx="3" ry=".75" /><path
			fill="#99aab5"
			d="M7 16h1v7H7zm9 0h1v7h-1z"
		/><path fill="#66757f" d="M6 22h3v1H6zm9 0h3v1h-3zm-8-7h1v1H7zm9 0h1v1h-1z" /></svg
	>
{/if}
