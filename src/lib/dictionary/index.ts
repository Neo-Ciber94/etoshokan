...
import { JMDict_SpaDictionary } from './jmdict/jmdict_spa';

class MultilingualDictionary extends Dictionary {
...
export const dictionary: Dictionary = new MultilingualDictionary();
